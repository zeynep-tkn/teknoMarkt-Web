  ...
  return (
    <div className='container mx-auto'>
        ...
        <div className="w-full lg:w-[50%] h-full lg:h-auto lg:flex lg:ml-5">
          <div className="w-[500px] h-full lg:h-auto lg:w-full flex-col gap-2 flex mt-10 lg:mt-0 m-auto">
            <div className="flex-col gap-2.5 flex">
              <div className="text-sky-900 font-semibold text-2xl">Oyun Konsolu</div>
              <div className="text-neutral-600 text-2xl font-semibold">$11,70</div>
            </div>
            <div className="justify-normal gap-2.5 flex">
              <Star count={5} />
              <div className="text-neutral-600 text-sm font-medium">Hiçbir inceleme yok</div>
            </div>
            <div className="gap-5 flex">
              <div className="text-neutral-800 text-lg font-medium">Kullanılabilirlik:</div>
              <div className="gap-3.5 flex">
                <div className="text-green-500 text-lg font-medium">Stokta</div>
              </div>
            </div>
            <div className="text-zinc-600 text-base font-small">Acele et! Stokta sadece 34 ürün kaldı!</div>
            <Separator />
            <div className="flex items-center">
              <span className='font-semibold text-black'>Renk:</span>
            ...
            <div className="flex items-center text-black">
              <span className='font-semibold '>Ebat:</span>
              <div className="flex gap-2 ml-3">
            ...
            <div className="flex items-center text-black">
              <span className='font-semibold '>Sayı:</span>
            ...
            <div className="flex gap-3 mt-3">
              <button className='w-56 h-16 bg-amber-500 text-white text-lg font-medium rounded-full '>Sepete ekle</button>
              <button className='w-56 h-16 bg-amber-500 text-white text-lg font-medium rounded-full '>Satın al</button>
            ...
            <div className="flex items-center text-black">
              <div className='font-semibold text-black'>Kategoriler:</div>
      ...
      <div className="flex gap-5 w-full h-full p-5 justify-center items-center">
        <button className='w-36 h-12 rounded-2xl border border-slate-400 font-semibold text-black'>Tanım</button>
        <button className='w-36 h-12 rounded-2xl border border-slate-400 bg-sky-900 font-semibold text-white'>Yorumlar</button>
      </div>
      <div className='p-5 flex justify-center items-center m-auto'>
        <Card className="w-[85%] h-42 p-8 flex flex-col gap-3">
          <span className='font-semibold text-sky-900'>Müşteri Yorumları</span>
          <span className='text-slate-500'>Herhangi bir yorum yok</span>
          <button className='bg-sky-900 text-white w-36 h-10 underline'>Yorum yaz</button>
        </Card>
      </div>
    </div>
  )

            ...
            <div className="flex justify-between">
                <div className='flex flex-wrap'>
                    <Link href="/products" className="ml-16 w-52 h-16 bg-amber-500 flex items-center justify-center hover:bg-amber-600">
                        <div className="text-white font-semibold text-base mr-3">Kategorileri İnceleyin</div>
                    ...
                    <Link href="/" className="w-32 h-16 flex items-center justify-center hover:bg-amber-500 group">
                        <div className="text-slate-500 font-semibold text-base group-hover:text-white">Ana Sayfa</div>

                    </Link>
                    <Link href="/products" className="w-32 h-16 flex items-center justify-center hover:bg-amber-500 cursor-pointer group">
                        <div className="text-slate-500 font-semibold text-base group-hover:text-white">Ürünler</div>
                    ...
                    <div className="w-32 h-16 flex items-center justify-center hover:bg-amber-500 cursor-pointer group">
                        <div className="text-slate-500 font-semibold text-base group-hover:text-white">Kategoriler</div>
                    ...
                    <div className="w-32 h-16 flex items-center justify-center hover:bg-amber-500 cursor-pointer group">
                        <div className="text-slate-500 font-semibold text-base group-hover:text-white">Hakkımızda</div>
                    </div>
                </div>
                <div className='font-semibold items-center flex mr-16 text-sky-800'>
                    <a href="">30 Gün Ücretsiz İade</a>
                </div>
            </div>
        </div>
    )
